...
public class UserServlet extends HttpServlet {
    ...
    private void sortUser(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        boolean isDESC = request.getParameter("condition").equals("0");
        System.out.println(by + " " + isDESC);
        List<User> result = userDAO.sort(by, isDESC);
    ...
    private void searchUser(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<User> result = userDAO.findByCountry(keyword);
        System.out.println(result.size());
        request.setAttribute("listUser", result);
        RequestDispatcher dispatcher = request.getRequestDispatcher("user/list.jsp");
        dispatcher.forward(request, response);
